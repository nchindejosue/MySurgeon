/*
  ...
  1. New Tables
    ...
    - `surgeon_details` - Extended surgeon information  
    - `vital_signs` - Patient vital signs records
    - `surgical_history` - Historical surgical procedures
    - `surgical_cases` - Current and upcoming surgical cases
    - `historical_surgical_data` - Data for ML predictions

  2. Security
    - Enable RLS on all tables
    - Add policies for role-based access control
    - Patients can only see their own data
    - Surgeons can see patient data they're treating
